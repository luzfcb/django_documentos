...
CKEDITOR.plugins.add( 'simplebox2', {
	...
	init: function( editor ) {
		...
		CKEDITOR.dialog.add( 'simplebox2', this.path + 'dialogs/simplebox2.js' );

		// Register the simplebox2 widget.
		editor.widgets.add( 'simplebox2', {
			// Allow all HTML elements, classes, and styles that this widget requires.
			// Read more about the Advanced Content Filter here:
			// * http://docs.ckeditor.com/#!/guide/dev_advanced_content_filter
			// * http://docs.ckeditor.com/#!/guide/plugin_sdk_integration_with_acf
			allowedContent:
				'div(!simplebox2,align-left,align-right,align-center){width};' +
				'div(!simplebox2-content); h2(!simplebox2-title)',

			// Minimum HTML which is required by this widget to work.
			requiredContent: 'div(simplebox2)',

			// Define two nested editable areas.
			editables: {
				title: {
					// Define CSS selector used for finding the element inside widget element.
					selector: '.simplebox2-title',
			...
			template:
				'<div class="simplebox2">' +
					'<h2 class="simplebox2-title">Title</h2>' +
					'<div class="simplebox2-content"><p>Content...</p></div>' +
				'</div>',
			...
			// editor.lang.simplebox2.* property. A string was used directly here to simplify this tutorial.
			...
			upcast: function( element ) {
				...
				// for all <div> elements with a "simplebox2" class.
				return element.name == 'div' && element.hasClass( 'simplebox2' );
			},
			...
			data: function() {
				...
				// The style is set on widget main element (div.simplebox2).
				if ( this.data.width == '' )
