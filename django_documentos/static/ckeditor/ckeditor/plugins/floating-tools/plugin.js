/**
 * Floating-Tools
 * from fork https://github.com/omerozyildiz/floating-tools
 * Author: Philipp Stracker (2013)
 * Original Project page: http://stracker-phil.github.com/Floating-Tools/
 */
(function () {
		...
		init: function (editor) {
			...
			getPrivateFloatingToolbarGroups = function (editor) {
				return editor._.floatingToolsGroups || ( editor._.floatingToolsGroups = [
						...
						{
							name: 'paragraph',
							items: ['JustifyCenter', 'Outdent', 'Indent', 'NumberedList', 'BulletedList']
						}
					]);
			}
