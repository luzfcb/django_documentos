    ...
    <script type="text/javascript">
        ...
        function ODFViewerPlugin() {
            function b(b) {
                ...
                a.async = !1;
                a.src = "{% static 'django_documentos/js/viewerjs/webodf.js' %}";
        ...
        function PDFViewerPlugin() {
            ...
            function r(d) {
                var a;
                b("{%  static 'django_documentos/js/viewerjs/compatibility.js' %}", function () {
                    b("{%  static 'django_documentos/js/viewerjs/pdf.js' %}");
                    b("{%  static 'django_documentos/js/viewerjs/ui_utils.js' %}");
                    b("{%  static 'django_documentos/js/viewerjs/text_layer_builder.js' %}");
                    b("{%  static 'django_documentos/js/viewerjs/pdfjsversion.js' %}", d)
                });
                a = document.createElementNS(document.head.namespaceURI, "style");
                a.setAttribute("media", "screen, print, handheld, projection");
                a.setAttribute("type", "text/css");
            ...
            this.initialize = function (a, b) {
                var c;
                r(function () {
                    PDFJS.workerSrc = "{%  static 'django_documentos/js/viewerjs/pdf.worker.js' %}";
        ...
        function Viewer(b, r) {
            ...
            var g = this, A = 40, y = 0.25, w = 4, E = "auto", d = !1, D = !1, L = !1, J, m = document.getElementById("viewer"), h = document.getElementById("canvasContainer"), n = document.getElementById("overlayNavigator"), C = document.getElementById("titlebar"), G = document.getElementById("toolbarContainer"), P = document.getElementById("toolbarLeft"), S = document.getElementById("toolbarMiddleContainer"), R = document.getElementById("scaleSelect"),
                    K = document.getElementById("dialogOverlay"), Q = document.getElementById("toolbarRight"), I, H = [], F, M, N, O;
        ...
        (function () {
            ...
            var k, q = [function () {
                ...
                return {
                    ...
                    }, path: "{%  static 'django_documentos/js/viewerjs/ODFViewerPlugin/' %}", getClass: function () {
                ...
                supportsMimetype: function (a) {
                    ...
                    return "pdf" === a
                }, path: "{%  static 'django_documentos/js/viewerjs/PDFViewerPlugin/' %}", getClass: function () {
