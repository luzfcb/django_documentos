jQuery(document).ready(function ($) {
    ...
    function LoadModalDiv(popUpObj) {
        ...
        if (bcgDiv === null){
            ...
            bcgDiv.setAttribute("style", " position:absolute; top:0px; left:0px;background-color:black; z-index:100;opacity: 0.8;filter:alpha(opacity=60); -moz-opacity: 0.8; overflow:hidden; display:none");
