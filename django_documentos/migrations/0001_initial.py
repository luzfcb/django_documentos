    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('revertido_em', models.DateField(auto_now=True, null=True)),
                ...
                ('criado_por', models.ForeignKey(related_name='django_documentos_documentconteudo_criado_por', on_delete=django.db.models.deletion.SET_NULL, blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='documentconteudo',
            name='modificado_por',
            field=models.ForeignKey(related_name='django_documentos_documentconteudo_modificado_por', on_delete=django.db.models.deletion.SET_NULL, blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True),
        ),
        migrations.AddField(
            model_name='documentconteudo',
            name='revertido_por',
            field=models.ForeignKey(related_name='django_documentos_documentconteudo_revertido_por', on_delete=django.db.models.deletion.SET_NULL, blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True),
        ),
    ]
